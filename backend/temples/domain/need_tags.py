...
KEYWORDS: Dict[NeedTag, List[str]] = {
    ...
    "money": ["金運", "収入", "給料", "貯金", "商売", "繁盛", "売上", "お金"],
    "study": ["学業", "合格", "試験", "受験", "資格", "勉強", "成績"],
    "health": ["健康", "体調", "病気", "不調", "体力", "回復", "治す"],
    "mental": ["不安", "落ち込み", "ストレス", "メンタル", "自信", "焦り", "しんどい"],
    "protection": ["厄除", "厄払い", "浄化", "邪気", "お祓い", "災難", "守護"],
    "courage": ["決断", "挑戦", "一歩", "背中押して", "勇気", "変わりたい", "踏み出す"],
    "focus": ["集中", "習慣", "継続", "怠け", "先延ばし", "やる気", "ルーティン"],
    "rest": ["休みたい", "休息", "疲れ", "回復", "睡眠", "眠れない", "リセット"],
...
REGEX: Dict[NeedTag, List[re.Pattern]] = {
    "protection": [re.compile(r"厄(除|払)"), re.compile(r"お祓い")],
