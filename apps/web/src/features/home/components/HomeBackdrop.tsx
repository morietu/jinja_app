 ...
 *     チップ群 ≈ 527〜672                        → pillの隙間 (副痚2)
 *     条件を追加する 〜 ANOTHER WAY IN ≈ 720〜780 → 空き帯 (副痚1)
 * 文字の上を通るのは最も低いopacityの副痚2だけに限定する。
 */
const BAND_TOP = 280;
 ...
 * どのxで切っても 主線 < 副痚2 < 副痚1 の順序が保たれ、交差は起こり得ない。
 *   主線  y 118→268 / 副痚2 y 260→430 / 副痚1 y 420→580
 *
...
/** 副痚1: 主線より細く、中程度のopacity。「条件を追加する」下の空き帯を通る。 */
const SUB_PATH_1 = "M -24 420 C 60 428, 126 468, 190 490 C 262 515, 336 552, 414 580";

/** 副痚2: 最も細く、最も低いopacity。チップ群のpillの隙間を縫って奥行きだけを担う。 */
    ...
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      ...
      */}
      ...
      >
        <defs>
          ...
          */}
          ...
          {/* 副痚2: 最も低いopacity。文字の上を通る唯一の線なので、
              輮郭を主張させず奥行きだけを担う強さに抑える。 */}
      ...
      {/*
        ...
        実際に見えるのはカード下端とチップ見出しの間に滋む暖かい光だけになる。
      */}
      <div
        className="absolute"
        style={{
